...
ActiveRecord::Schema[7.1].define(version: 2024_07_09_011344) do
  ...
  create_table "conversations", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "title"
    t.boolean "send_documentation", default: true
    t.boolean "send_baseline_prompt", default: true
    t.boolean "send_project_code", default: true
  ...
  create_table "game_versions", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_game_versions_on_user_id"
  end
